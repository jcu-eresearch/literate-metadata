...
(Top-level element has index)-->
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="ISO 19139 Geographic Identifiers validator."
                              schemaVersion="">
         <xsl:comment>
 ...
 <xsl:value-of select="$fileDirParameter"/>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">ISO 19139 Geographic Identifiers validator.</svrl:text>
   ...
   <xsl:template match="gmd:geographicIdentifier/gmd:MD_Identifier/gmd:code/gco:CharacterString"
      ...
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="gmd:geographicIdentifier/gmd:MD_Identifier/gmd:code/gco:CharacterString"/>
      <xsl:variable name="URI-reference"
                    select="../../gmd:authority/gmd:CI_Citation/gmd:identifier/gmd:MD_Identifier/gmd:code/gco:CharacterString"/>
      ...
      <!--ASSERT debug-->
      <xsl:choose>
         <xsl:when test=" string-length(normalize-space( $URI )) &gt; 0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="string-length(normalize-space( $URI )) &gt; 0">
      ...
      <!--ASSERT debug-->
      <xsl:choose>
         <xsl:when test="$code-list-document"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$code-list-document">
               <xsl:attribute name="role">debug</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
      ...
      <!--ASSERT debug-->
      <xsl:choose>
         <xsl:when test=" string-length(normalize-space( $fragment )) &gt; 0"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="string-length(normalize-space( $fragment )) &gt; 0">
               <xsl:attribute name="role">debug</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$dictionary">
               <xsl:attribute name="role">debug</xsl:attribute>
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
      ...
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test=" $dictionary/gmx:codeEntry/gmx:CodeDefinition[gml:identifier = current()]"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="$dictionary/gmx:codeEntry/gmx:CodeDefinition[gml:identifier = current()]">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text> 
              Could not find the geographic identifier code "<xsl:text/>
